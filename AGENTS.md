...
6. **Consent Gate:** Explicit confirmation before git push, PR creation, MCP transmission, or live LLM transport (`⫻cmd/llm` SpaceXAI/Gemini → KickGuard **CONSENT & INVOKE**).
